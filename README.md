...
- **Bước 2:** Tải tệp `DJI_Mimo_VietHoa.zip` từ mục Releases về thiết bị
...
- Tải `DJI_Mimo_VietHoa.zip` từ Releases (bên trong có 4 file APK, gồm 1 `base.apk` và 3 file split khác).
...
6. Kiểm tra lại cú pháp XML trước khi tạo PR.

## Giấy phép
Phần bản dịch và các nội dung do dự án này tạo ra được phát hành theo [MIT License](https://github.com/Astear17/mimo.sz/blob/main/LICENSE).
